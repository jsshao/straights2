...
public:
	DeckGUI();
	virtual ~DeckGUI();
	Glib::RefPtr<Gdk::Pixbuf> getCard(Rank f, Suit s );   // Returns the image for the specified card.
	Glib::RefPtr<Gdk::Pixbuf> getNull();                 // Returns the image to use for the placeholder.
